...
!(function (e, t) {
  ...
  function wt(e) {
    ...
    return {
      ...
      getWidgetUiState: function (e) {
        return h.filter(De).reduce(function (e, t) {
    ...
    return function (e) {
      ...
      var i = Object.keys(s).reduce(function (e, t) {
          ...
          return Array.isArray(r)
            ...
            : "string" == typeof r
            ? [].concat(P(e), [
                ui({ attributeName: t, attributeValue: r, attributeScore: i }),
              ])
            : e;
        }, []),
        o = W(
  ...
  function Ra(e) {
    ...
    return (
      (t.className = ba({ descendantName: "widget" })), e.appendChild(t), t
    );
  }
  function Sa(e) {
    var t = e || {},
        ...
        (t.__H.__h.length &&
          ((1 !== vs.push(t) && hs === Mn.requestAnimationFrame) ||
            (
              ...
              function (e) {
                function t() {
                  clearTimeout(r), Ts && cancelAnimationFrame(n), setTimeout(e);
                }
                var n,
                  r = setTimeout(t, 100);
